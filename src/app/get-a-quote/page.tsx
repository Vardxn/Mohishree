...
export default function GetQuotePage() {
  ...
  const emailLink = 'mailto:mohishreejcmk2025@gmail.com?subject=Quote%20Request';
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">Share your facility requirements via WhatsApp or email</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-1">Site Assessment</h3>
                  <p className="text-text-secondary">We understand your needs through discussion or site visit</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-1">Custom Quote</h3>
                  <p className="text-text-secondary">Receive a detailed, customized quote for your needs</p>
                </div>
              </div>
            </div>
          </div>
